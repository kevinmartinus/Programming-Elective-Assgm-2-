...
<head>
    ...
    <title>FeastOrder - Garden Salad Bites</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 2 = Garden Salad Bites,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_gardenSalad.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Garden Salad Bites</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Light &amp; Fresh</span>
                <span class="tag-pill">Vegetarian</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                A refreshing mix of crisp mixed greens, cherry tomatoes, and creamy avocado, tossed in a bright citrus vinaigrette. Light, clean, and full of colour.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Mixed greens</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Cherry tomato</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>Avocado</span><span class="ingredient-qty">0.5 kg</span></div>
                <div class="ingredient-row"><span>Citrus vinaigrette</span><span class="ingredient-qty">0.05 kg</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> No major allergens. Let us know of any dietary restrictions when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">150 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">8g fat</div></div>
                <div class="stat-chip"><div class="stat-value">12g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Avocado" id="addon-avocado">
                        <label class="addon-pill-label" for="addon-avocado">Extra Avocado</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Add Grilled Chicken" id="addon-chicken">
                        <label class="addon-pill-label" for="addon-chicken">Add Grilled Chicken</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 7.50</span>
