...
<head>
    ...
    <title>FeastOrder - Chicken Satay Skewers</title>
    ...
    <style>
        ...
        /* Ingredients grid, matching the reference layout: two columns of
           "name — quantity" pairs */
        .ingredient-grid {
            display: grid;
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 3 = Chicken Satay Skewers,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_chickenSatay.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <span class="category-label">Appetizers</span>
                    <h1 class="fs-2 fw-bold mb-0">Chicken Satay Skewers</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Appetizers</span>
                <span class="tag-pill">Grilled</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Tender chicken thigh, marinated overnight in a blend of turmeric, lemongrass, and coconut milk,
                grilled over open flame until lightly charred. Served with our house-made peanut sauce and a
                refreshing cucumber relish on the side — a favorite to start any meal.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Chicken thigh</span><span class="ingredient-qty">0.3 kg</span></div>
                <div class="ingredient-row"><span>Peanut sauce</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>Cucumber relish</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Bamboo skewers</span><span class="ingredient-qty">4 pcs</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains peanuts. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip">
                    <div class="stat-value">260 kcal</div>
                </div>
                <div class="stat-chip">
                    <div class="stat-value">14g fat</div>
                </div>
                <div class="stat-chip">
                    <div class="stat-value">9g carbs</div>
                </div>
            </div>
                ...
                <div class="cart-status-banner">
                    ...
                    <div class="cart-status-controls">
                        <form action="${pageContext.request.contextPath}/cart" method="post">
                            ...
                            <button type="submit" aria-label="Decrease quantity in cart">−</button>
                        </form>
                        <form action="${pageContext.request.contextPath}/cart" method="post">
                            <input type="hidden" name="action" value="update">
                            <input type="hidden" name="index" value="${cartIndex}">
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Peanut Sauce" id="addon-sauce">
                        <label class="addon-pill-label" for="addon-sauce">Extra Peanut Sauce</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="2 Extra Skewers" id="addon-skewers">
                        <label class="addon-pill-label" for="addon-skewers">2 Extra Skewers</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 8.90</span>
                    <div class="qty-stepper">
                        <button type="button" onclick="stepQuantity(this, -1)" aria-label="Decrease quantity">−</button>
