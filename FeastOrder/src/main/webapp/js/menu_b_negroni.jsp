...
<head>
    ...
    <title>FeastOrder - Negroni</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This drink's session-cart status: itemId 17 = Negroni,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_negroni.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Negroni</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Equal parts gin, Campari, and sweet vermouth, stirred slowly over ice and finished with an orange twist &mdash; bittersweet, bold, and unmistakably Italian.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Gin</span><span class="ingredient-qty">30 ml</span></div>
                <div class="ingredient-row"><span>Campari</span><span class="ingredient-qty">30 ml</span></div>
                <div class="ingredient-row"><span>Sweet vermouth</span><span class="ingredient-qty">30 ml</span></div>
                <div class="ingredient-row"><span>Orange twist</span><span class="ingredient-qty">1 garnish</span></div>
            </div>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">170 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">24% ABV</div></div>
                <div class="stat-chip"><div class="stat-value">90 ml serving</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Campari" id="addon-campari">
                        <label class="addon-pill-label" for="addon-campari">Extra Campari</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Orange Twist Upgrade" id="addon-twist">
                        <label class="addon-pill-label" for="addon-twist">Orange Twist Upgrade</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 30.00</span>
