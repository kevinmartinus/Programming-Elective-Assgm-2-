...
<head>
    ...
    <title>FeastOrder - Espresso Martini</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This drink's session-cart status: itemId 15 = Espresso Martini,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_espressoMartini.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Espresso Martini</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Classic Cocktail</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Vodka shaken hard with coffee liqueur and a fresh shot of espresso until dark, rich, and topped with a silky crema &mdash; the after-dinner cocktail for coffee lovers.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Vodka</span><span class="ingredient-qty">50 ml</span></div>
                <div class="ingredient-row"><span>Coffee liqueur</span><span class="ingredient-qty">25 ml</span></div>
                <div class="ingredient-row"><span>Fresh espresso</span><span class="ingredient-qty">25 ml</span></div>
                <div class="ingredient-row"><span>Sugar syrup</span><span class="ingredient-qty">to taste</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains alcohol and caffeine. Must be of legal drinking age to order. Please drink responsibly.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">190 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">17% ABV</div></div>
                <div class="stat-chip"><div class="stat-value">120 ml serving</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Coffee Liqueur" id="addon-liqueur">
                        <label class="addon-pill-label" for="addon-liqueur">Extra Coffee Liqueur</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 32.00</span>
