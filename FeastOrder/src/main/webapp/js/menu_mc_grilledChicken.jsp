...
<head>
    ...
    <title>FeastOrder - Grilled Chicken Rice</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 4 = Grilled Chicken Rice,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/FO_grilledChickenRice.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Grilled Chicken Rice</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Char-grilled chicken thigh marinated in a savoury herb blend, served over fragrant jasmine rice with a crisp side salad.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Chicken thigh</span><span class="ingredient-qty">0.35 kg</span></div>
                <div class="ingredient-row"><span>Jasmine rice</span><span class="ingredient-qty">0.2 kg</span></div>
                <div class="ingredient-row"><span>Side salad</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>House sauce</span><span class="ingredient-qty">0.05 kg</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains soy. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">480 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">16g fat</div></div>
                <div class="stat-chip"><div class="stat-value">52g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Rice" id="addon-rice">
                        <label class="addon-pill-label" for="addon-rice">Extra Rice</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Chicken" id="addon-chicken">
                        <label class="addon-pill-label" for="addon-chicken">Extra Chicken</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 12.90</span>
