...
<head>
    ...
    <title>FeastOrder - Aperol Spritz</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This drink's session-cart status: itemId 14 = Aperol Spritz,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_aperolSpritz.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Aperol Spritz</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Aperitivo</span>
                <span class="tag-pill">Contains Alcohol</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Italy's most iconic aperitivo &mdash; bittersweet Aperol topped with chilled Prosecco and a splash of soda, poured over ice and finished with a fresh orange slice. Light, bright, and endlessly refreshing.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Aperol</span><span class="ingredient-qty">60 ml</span></div>
                <div class="ingredient-row"><span>Prosecco</span><span class="ingredient-qty">90 ml</span></div>
                <div class="ingredient-row"><span>Soda water</span><span class="ingredient-qty">30 ml</span></div>
                <div class="ingredient-row"><span>Orange slice</span><span class="ingredient-qty">1 garnish</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains alcohol. Must be of legal drinking age to order. Please drink responsibly.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">120 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">11% ABV</div></div>
                <div class="stat-chip"><div class="stat-value">180 ml serving</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Aperol Shot" id="addon-shot">
                        <label class="addon-pill-label" for="addon-shot">Extra Aperol Shot</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Orange Garnish" id="addon-orange">
                        <label class="addon-pill-label" for="addon-orange">Extra Orange Garnish</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Make it a Double" id="addon-double">
                        <label class="addon-pill-label" for="addon-double">Make it a Double</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 28.00</span>
