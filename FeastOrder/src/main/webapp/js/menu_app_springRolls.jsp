...
<head>
    ...
    <title>FeastOrder - Spring Rolls</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 1 = Spring Rolls,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/FO_springRoll.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Spring Rolls</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Crispy</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Crispy spring rolls packed with shredded cabbage, carrot, and glass noodles, hand-rolled and fried to a delicate golden crunch. Served with a tangy-sweet house dipping sauce on the side.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Cabbage</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Carrot</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>Glass noodles</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>Spring roll wrapper</span><span class="ingredient-qty">6 pcs</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains gluten and soy. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">210 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">6g fat</div></div>
                <div class="stat-chip"><div class="stat-value">28g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Dipping Sauce" id="addon-sauce">
                        <label class="addon-pill-label" for="addon-sauce">Extra Dipping Sauce</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="2 Extra Rolls" id="addon-extra">
                        <label class="addon-pill-label" for="addon-extra">2 Extra Rolls</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 5.90</span>
