...
<head>
    ...
    <title>FeastOrder - Cr'me Br'l'e</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 13 = Cr'me Br'l'e,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_cremeBrulee.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Cr&egrave;me Br&ucirc;l&eacute;e</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Silky vanilla custard beneath a crisp, caramelised sugar crust &mdash; a timeless French classic.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Egg custard</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Vanilla bean</span><span class="ingredient-qty">1 pod</span></div>
                <div class="ingredient-row"><span>Caramelised sugar</span><span class="ingredient-qty">0.03 kg</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains dairy and eggs. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">380 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">27g fat</div></div>
                <div class="stat-chip"><div class="stat-value">24g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Caramel Crust" id="addon-caramel">
                        <label class="addon-pill-label" for="addon-caramel">Extra Caramel Crust</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Add Berries" id="addon-berries">
                        <label class="addon-pill-label" for="addon-berries">Add Berries</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 7.20</span>
