...
<head>
    ...
    <title>FeastOrder - Beef Burger</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 5 = Beef Burger,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/FO_beefBurger.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Beef Burger</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                A juicy beef patty topped with melted cheddar, crisp lettuce, and tomato, stacked in a lightly toasted brioche bun.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Beef patty</span><span class="ingredient-qty">0.2 kg</span></div>
                <div class="ingredient-row"><span>Cheddar cheese</span><span class="ingredient-qty">0.03 kg</span></div>
                <div class="ingredient-row"><span>Brioche bun</span><span class="ingredient-qty">1 pc</span></div>
                <div class="ingredient-row"><span>Lettuce &amp; tomato</span><span class="ingredient-qty">0.08 kg</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains gluten and dairy. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">620 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">34g fat</div></div>
                <div class="stat-chip"><div class="stat-value">41g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Cheese" id="addon-cheese">
                        <label class="addon-pill-label" for="addon-cheese">Extra Cheese</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Patty" id="addon-patty">
                        <label class="addon-pill-label" for="addon-patty">Extra Patty</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 11.50</span>
