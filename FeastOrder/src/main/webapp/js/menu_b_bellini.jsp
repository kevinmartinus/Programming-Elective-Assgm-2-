...
<head>
    ...
    <title>FeastOrder - Bellini</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This drink's session-cart status: itemId 16 = Bellini,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_bellini.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Bellini</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Italian Classic</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Chilled Prosecco poured gently over silky white peach pur&eacute;e &mdash; a Venetian classic invented at Harry's Bar in 1948, and still one of the most elegant ways to start a meal.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Prosecco</span><span class="ingredient-qty">100 ml</span></div>
                <div class="ingredient-row"><span>White peach purée</span><span class="ingredient-qty">50 ml</span></div>
            </div>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">140 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">8% ABV</div></div>
                <div class="stat-chip"><div class="stat-value">150 ml serving</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Peach Pur&eacute;e" id="addon-peach">
                        <label class="addon-pill-label" for="addon-peach">Extra Peach Pur&eacute;e</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Prosecco Top-Up" id="addon-topup">
                        <label class="addon-pill-label" for="addon-topup">Prosecco Top-Up</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 26.00</span>
