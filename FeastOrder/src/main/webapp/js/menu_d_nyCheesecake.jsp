...
<head>
    ...
    <title>FeastOrder - New York Cheesecake</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 12 = New York Cheesecake,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_nyCheesecake.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">New York Cheesecake</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Baked</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                A rich, baked cheesecake with a buttery biscuit base, topped with a bright berry compote.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Cream cheese</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Biscuit base</span><span class="ingredient-qty">0.06 kg</span></div>
                <div class="ingredient-row"><span>Berry compote</span><span class="ingredient-qty">0.05 kg</span></div>
            </div>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">460 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">26g fat</div></div>
                <div class="stat-chip"><div class="stat-value">44g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Berry Compote" id="addon-berry">
                        <label class="addon-pill-label" for="addon-berry">Extra Berry Compote</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Slice" id="addon-slice">
                        <label class="addon-pill-label" for="addon-slice">Extra Slice</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 7.90</span>
