...
<head>
    ...
    <title>FeastOrder - Mango Sticky Rice</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 11 = Mango Sticky Rice,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_mangoSticky.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Mango Sticky Rice</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Tropical</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Sweet glutinous rice paired with fresh, ripe mango and a silky coconut cream &mdash; a classic tropical favourite.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Glutinous rice</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Fresh mango</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Coconut cream</span><span class="ingredient-qty">0.08 kg</span></div>
            </div>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">350 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">9g fat</div></div>
                <div class="stat-chip"><div class="stat-value">62g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Mango" id="addon-mango">
                        <label class="addon-pill-label" for="addon-mango">Extra Mango</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Coconut Cream" id="addon-cream">
                        <label class="addon-pill-label" for="addon-cream">Extra Coconut Cream</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 6.50</span>
