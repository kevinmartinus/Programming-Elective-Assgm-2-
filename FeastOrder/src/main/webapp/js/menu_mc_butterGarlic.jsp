...
<head>
    ...
    <title>FeastOrder - Butter Garlic Prawn Pasta</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 7 = Butter Garlic Prawn Pasta,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_butterGarlic.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Butter Garlic Prawn Pasta</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Seafood</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Linguine tossed in a fragrant butter garlic sauce with plump, pan-seared prawns &mdash; simple, rich, and deeply satisfying.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Linguine</span><span class="ingredient-qty">0.2 kg</span></div>
                <div class="ingredient-row"><span>Prawns</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Butter garlic sauce</span><span class="ingredient-qty">0.08 kg</span></div>
                <div class="ingredient-row"><span>Parsley garnish</span><span class="ingredient-qty">to taste</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains shellfish and gluten. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">590 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">22g fat</div></div>
                <div class="stat-chip"><div class="stat-value">68g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Prawns" id="addon-prawns">
                        <label class="addon-pill-label" for="addon-prawns">Extra Prawns</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Parmesan" id="addon-parmesan">
                        <label class="addon-pill-label" for="addon-parmesan">Extra Parmesan</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 16.50</span>
