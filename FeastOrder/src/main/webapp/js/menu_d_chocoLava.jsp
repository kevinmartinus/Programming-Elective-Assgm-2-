...
<head>
    ...
    <title>FeastOrder - Chocolate Lava Cake</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 9 = Chocolate Lava Cake,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/FeastOrder_chocoLava.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Chocolate Lava Cake</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                A warm chocolate cake with a molten centre, dusted with powdered sugar and finished with a scoop of vanilla ice cream.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Dark chocolate</span><span class="ingredient-qty">0.08 kg</span></div>
                <div class="ingredient-row"><span>Butter</span><span class="ingredient-qty">0.05 kg</span></div>
                <div class="ingredient-row"><span>Vanilla ice cream</span><span class="ingredient-qty">1 scoop</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains gluten, dairy, and eggs. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">390 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">19g fat</div></div>
                <div class="stat-chip"><div class="stat-value">46g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Ice Cream" id="addon-icecream">
                        <label class="addon-pill-label" for="addon-icecream">Extra Ice Cream</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Chocolate Drizzle" id="addon-drizzle">
                        <label class="addon-pill-label" for="addon-drizzle">Extra Chocolate Drizzle</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 6.90</span>
