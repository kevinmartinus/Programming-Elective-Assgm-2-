...
<head>
    ...
    <title>FeastOrder - Classic Tiramisu</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 10 = Classic Tiramisu,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_tiramisu.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Classic Tiramisu</h1>
                </div>
            ...
            <div class="mt-2 mb-3 d-flex align-items-center flex-wrap gap-2">
                ...
                <span class="tag-pill">Desserts</span>
                <span class="tag-pill">Classic</span>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Delicate ladyfinger sponge soaked in rich espresso, layered with silky mascarpone cream and finished with a dusting of cocoa &mdash; an Italian classic done right.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Ladyfinger sponge</span><span class="ingredient-qty">0.1 kg</span></div>
                <div class="ingredient-row"><span>Espresso</span><span class="ingredient-qty">0.05 L</span></div>
                <div class="ingredient-row"><span>Mascarpone cream</span><span class="ingredient-qty">0.15 kg</span></div>
                <div class="ingredient-row"><span>Cocoa dust</span><span class="ingredient-qty">to taste</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains gluten, dairy, and eggs. May contain traces of caffeine. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">420 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">24g fat</div></div>
                <div class="stat-chip"><div class="stat-value">38g carbs</div></div>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Mascarpone" id="addon-mascarpone">
                        <label class="addon-pill-label" for="addon-mascarpone">Extra Mascarpone</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Cocoa Dust" id="addon-cocoa">
                        <label class="addon-pill-label" for="addon-cocoa">Extra Cocoa Dust</label>
