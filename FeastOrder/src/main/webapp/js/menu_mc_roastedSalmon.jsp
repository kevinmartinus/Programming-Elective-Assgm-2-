...
<head>
    ...
    <title>FeastOrder - Herb-Roasted Salmon</title>
...
<body class="bg-light">
    ...
    <main class="container py-5">
        ...
        <%-- This dish's session-cart status: itemId 8 = Herb-Roasted Salmon,
        ...
        <div class="item-detail-hero"
             style="background-image: url('${pageContext.request.contextPath}/image/menu_roastedSalmon.jpg');">
        ...
        <div class="item-detail-card">
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <h1 class="fs-2 fw-bold mb-0">Herb-Roasted Salmon</h1>
                </div>
            ...
            <p class="mb-3" style="opacity:0.85;">
                Oven-roasted salmon fillet finished with a bright lemon butter sauce, served alongside seasonal greens.
            </p>

            <h6 class="detail-section-label">Ingredients</h6>
            <div class="ingredient-grid mb-3">
                <div class="ingredient-row"><span>Salmon fillet</span><span class="ingredient-qty">0.22 kg</span></div>
                <div class="ingredient-row"><span>Seasonal greens</span><span class="ingredient-qty">0.12 kg</span></div>
                <div class="ingredient-row"><span>Lemon butter sauce</span><span class="ingredient-qty">0.05 kg</span></div>
            </div>
            <p class="mb-0" style="opacity:0.7; font-size:0.82rem;">
                <i class="bi bi-info-circle"></i> Contains fish and dairy. Please let us know of any allergies when ordering.
            </p>
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                <div class="stat-chip"><div class="stat-value">540 kcal</div></div>
                <div class="stat-chip"><div class="stat-value">28g fat</div></div>
            ...
            <form action="${pageContext.request.contextPath}/cart" method="post"
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Salmon" id="addon-salmon">
                        <label class="addon-pill-label" for="addon-salmon">Extra Salmon</label>

                        <input class="addon-pill-input addon-checkbox" type="checkbox" value="Extra Greens" id="addon-greens">
                        <label class="addon-pill-label" for="addon-greens">Extra Greens</label>
                ...
                <div class="detail-sticky-bar">
                    <span class="item-detail-price">RM 21.00</span>
