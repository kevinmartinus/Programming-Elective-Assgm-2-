    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="adminNavMain">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link <%= currentUri.endsWith("/admin/dashboard") ? "active" : "" %>"
                       href="${pageContext.request.contextPath}/admin/dashboard">Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <%= currentUri.endsWith("/admin/menu") ? "active" : "" %>"
                       href="${pageContext.request.contextPath}/admin/menu">Manage Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <%= currentUri.endsWith("/admin/orders") ? "active" : "" %>"
                       href="${pageContext.request.contextPath}/admin/orders">View Orders</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <%= currentUri.endsWith("/admin/users") ? "active" : "" %>"
