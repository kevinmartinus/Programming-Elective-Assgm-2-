...
<%-- Admin Dashboard - the landing page an admin sees right after logging in. Shows quick stats (menu items, orders, users) and links to the two
     other admin pages. --%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <%-- Page-specific styling for the hero banner, stat cards, and navigation cards below --%>
    <style>
        .admin-hero {
            text-align: center;
            padding: 2.5rem 1rem;
...
<body class="bg-light">
	...
	<%-- Shared nav bar with links to Dashboard/Manage Menu/View Orders --%>
