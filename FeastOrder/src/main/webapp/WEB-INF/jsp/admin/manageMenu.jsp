                            ...
                            <tbody>
                                <c:forEach var="item" items="${menuItems}">
                                    <tr>
                                        ...
                                        <td>RM<fmt:formatNumber value="${item.price}" minFractionDigits="2" maxFractionDigits="2"/></td>
                                        ...
                                        <td class="text-end">
                                            <button type="button" class="btn btn-outline-primary btn-sm rounded-pill edit-item-btn"
                                                    ...
                                                    data-item-addons="${item.addonOptions}"
        ...
        <div class="modal-dialog">
            <form method="post" action="${pageContext.request.contextPath}/admin/menu" class="modal-content" onsubmit="return validateMenuItemForm(this);">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label class="form-label">Ingredients (structured, for the detail page's ingredient list)</label>
                        <input type="text" name="ingredients" class="form-control" placeholder="e.g. Cabbage:0.15 kg, Carrot:0.1 kg">
                        <div class="form-text">Format: Name:Quantity, separated by commas. Leave blank to hide this section.</div>
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Add-on Options (shown as selectable choices)</label>
                        <input type="text" name="addonOptions" class="form-control" placeholder="e.g. Extra Cheese, Add Bacon, Add Egg">
                        <div class="form-text">Comma-separated list. Leave blank to hide add-ons for this item.</div>
                    </div>
                    <div class="mb-2">
        ...
        <div class="modal-dialog">
            <form method="post" action="${pageContext.request.contextPath}/admin/menu" class="modal-content" onsubmit="return validateMenuItemForm(this);">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label class="form-label">Ingredients (structured, for the detail page's ingredient list)</label>
                        <input type="text" name="ingredients" id="editIngredients" class="form-control" placeholder="e.g. Cabbage:0.15 kg, Carrot:0.1 kg">
                        <div class="form-text">Format: Name:Quantity, separated by commas. Leave blank to hide this section.</div>
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Add-on Options (shown as selectable choices)</label>
                        <input type="text" name="addonOptions" id="editAddonOptions" class="form-control" placeholder="e.g. Extra Cheese, Add Bacon, Add Egg">
                        <div class="form-text">Comma-separated list. Leave blank to hide add-ons for this item.</div>
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Nutritional Info</label>
    ...
    <script>
        ...
        document.querySelectorAll('.edit-item-btn').forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                document.getElementById('editIngredients').value = btn.dataset.itemIngredients || '';
                document.getElementById('editAddonOptions').value = btn.dataset.itemAddons || '';
