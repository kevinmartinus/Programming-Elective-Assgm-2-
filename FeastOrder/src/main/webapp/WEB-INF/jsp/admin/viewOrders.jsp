                    ...
                    <tbody>
                        <c:forEach var="order" items="${orders}" varStatus="loop">
                            <tr class="order-row" onclick="toggleDetail(${order.orderId})" onkeydown="toggleDetail(${order.orderId})" tabindex="0">
                                ...
                                <td><fmt:formatNumber value="${order.totalPrice}" type="currency" currencySymbol="RM"/></td>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="item" items="${order.items}">
                                                            <tr>
                                                                <td>${item.itemName}</td>
                                                                <td>${item.quantity}</td>
                                                                <td><fmt:formatNumber value="${item.unitPrice}" type="currency" currencySymbol="RM"/></td>
                                                                <td><fmt:formatNumber value="${item.subtotal}" type="currency" currencySymbol="RM"/></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
